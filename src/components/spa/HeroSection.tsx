  ...
  return (
    <section className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&w=800&h=1200"
          alt="Spa ambiance"
      ...
      <div className="relative z-10 text-center px-6 max-w-md mx-auto">
        ...
        >
          ...
          <h1 className="font-display text-4xl sm:text-5xl leading-tight mb-4 text-primary-foreground">
            Our Luxury<br />
            <span className="italic">Spa Treatments</span>
          </h1>
